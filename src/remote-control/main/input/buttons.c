...
static const button_pin_map_t s_button_pin_map[] = {
    { BOARD_BUTTON_PREVIOUS_TRACK_GPIO, BUTTON_EVENT_ID_PREVIOUS_TRACK_PRESSED },
    { BOARD_BUTTON_PLAY_PAUSE_GPIO,     BUTTON_EVENT_ID_PLAY_PAUSE_PRESSED     },
    { BOARD_BUTTON_NEXT_TRACK_GPIO,     BUTTON_EVENT_ID_NEXT_TRACK_PRESSED     },
};
